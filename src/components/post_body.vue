    ...
    <div class='body_post'>
        ...
        <ul>
            <li v-bind:key='index' v-for="(item, index ) in post">
                ...
                <p class='post__user'> {{ item.user}} </p>
...
export default {
    ...
    data() {
        return {
            ...
            post: [
                {user :'Utilisateur1',title :'Titre1',comments:'Commentaires'},
                {user :'Utilisateur2',title :'Titre2',comments:'Commentaires'},
                {user :'Utilisateur3',title :'Titre3',comments:'Commentaires'},
                {user :'Utilisateur4',title :'Titre4',comments:'Commentaires'}
                

             ],
            comments: [
                {user :'Utilisateur1',comments:'Commentaires'},
                {user :'Utilisateur2',comments:'Commentaires'},
                {user :'Utilisateur3',comments:'Commentaires'},
                {user :'Utilisateur4',comments:'Commentaires'}
             ],
